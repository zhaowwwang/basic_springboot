    ...
    <div class="dateBig">
        <div style="height:10px">
            <ul class="uls" id="optProject">
                <shiro:hasPermission name="/systemResource/addResource">
                    <li class="default">
                        <a opt-id="add" href="javascript:;">添加资源</a>
                    </li>
                </shiro:hasPermission>
                <shiro:hasPermission name="/systemResource/editResource">
                    <li class="default">
                        <a opt-id="edit" href="javascript:;">编辑</a>
                    </li>
                </shiro:hasPermission>
                <shiro:hasPermission name="/systemResource/delResource">
                    <li class="default">
            ...
            <ul class="detailedQw" id="selectIDVal">
                <li>
                    <input type="text" name="resourceName" placeholder="资源名称">
                    <div class="searchSelect">
                        <select id="selectPid" name='pid'></select>
                    </div>
                </li>
                <li>
