...
(function($) {
	$.fn.lightbox = function(options) {
		...
		function initialize() {
			...
			// <div><a  target="_blank"  href="daimg.aspx">查看原图</a></div>
			var outerImage = '<div width="900px" id="outerImageContainer" style="overflow:scroll" ><div  id="imageContainer" ><iframe id="lightboxIframe"></iframe><img  id="lightboxImage" border="1" onmousewheel="return zoomimg(this)" class="drag" alt="可以缩放的图片"  /><div id="hoverNav"><a href="javascript://" title="' + opts.strings.prevLinkTitle + '" id="prevLink"></a><a href="javascript://" id="nextLink" title="' + opts.strings.nextLinkTitle + '"></a></div><div id="loading"><a href="javascript://" id="loadingLink"><img src="' + opts.fileLoadingImage + '"></a></div></div></div>';
			var imageData = '<div id="imageDataContainer" class="clearfix"><div id="imageData"><div id="imageDetails"><span id="caption"></span><a style="cursor:pointer;font-weight:bold; font-size:13px;color:Blue;"  onClick="zoombig(lightboxImage)">『点击放大』</a><a style="cursor:pointer;font-weight:bold; font-size:13px;color:Blue;"  onClick="zoomsmall(lightboxImage)">『点击缩小』</a><span style="font-weight:bold; font-size:medium;"  id="numberDisplay"></span></div><div id="bottomNav"><a style="font-weight:bold; font-size:medium;">当前比例：<span style="color:#FF9900" id="zoomvl">100%</span></a>';
			//<a href="#" onClick="zoombig(lightboxImage)">『放大10%』</a><a href="#" onClick="zoomsmall(lightboxImage)">『缩小10%』</a>
			//<a href="#" onClick="lightboxImage.style.zoom="100%";zoomvl.innerText="100%";">『恢复100%』</a>
			if (opts.displayHelp) {
...
//			$("#overlay, #lightbox").click(function(){ end(); }).hide();
		...
		function resizeImageContainer(imgWidth, imgHeight) {
			...
			var widthNew = Math.max(350, imgWidth  + (opts.borderSize * 2)+300);
